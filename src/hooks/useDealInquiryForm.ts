...
import { getCalendlyUrlForAction, getRoleType } from '@/lib/calendly-routing'
import type { ContactVerdict } from '@/lib/verify-contact'


// Calendly routing lives in @/lib/calendly-routing so the one-page form shares
// it. Re-exported here because ConversationalForm imports it from this module.
export { CALENDLY_URLS, QUICK_SCHEDULE_URL } from '@/lib/calendly-routing'
