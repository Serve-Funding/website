  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    featureRows: [
      ...
      },
      {
        ...
        productA: 'Off balance sheet, because it is a sale rather than debt',
    ...
    mikeQuotes: [
      ...
      },
      {
        ...
        context:
          'Mike\'s water-in-a-cup analogy for how the revolving mechanic actually works, and it applies equally to factoring and ABL.',
      },
      {
        quote:
        ...
        context:
          'Mike on the underwriting difference, and why factoring works for borrowers whose own credit story is imperfect.',
      },
    ],
    faqs: [
      {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    mikeQuotes: [
      {
        quote:
          'the lender sets up what\'s called a lockbox. It\'s like a different bank account that the payments will go to that account. So you would inform your customers, look, starting on January the 23rd or whenever…please remit payments over here to this Bank of America account… So it\'s not like you\'re making payments to the line. The payments come right into them and it immediately pays down… more availability is, the availability rises for you. It\'s almost like water in a cup, you know.',
        context:
          'Mike\'s water-in-a-cup analogy for how a revolving line actually works, and it applies whether the line is factoring, ABL, or a revenue-based revolver.',
      },
      {
        quote:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'No. A business credit card is unsecured personal-credit-driven revolving capital at consumer-style rates (often 20%+ APR), with credit limits typically capped at $50K–$100K. A real business line of credit is underwritten to the business against revenue, AR or assets, and sized in the hundreds of thousands to tens of millions, and priced in the Prime + 2–8% range. For anything beyond minor expense smoothing, the business line of credit is the right tool.',
      },
    ],
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    whenToPickA: {
      ...
      bullets: [
        ...
        'Speed matters, and you need the money in days, not weeks',
      ],
    },
    whenToPickB: {
      narrative:
