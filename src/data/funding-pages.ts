...
export const fundingPages: FundingPage[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    terms: [
      ...
      { label: 'Payment frequency', value: 'Monthly — no daily or weekly ACH sweeps' },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    terms: [
      ...
      { label: 'Early payoff', value: 'Credit for early payoff on most products — you pay for the days you use' },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    terms: [
      ...
      { label: 'Finished goods', value: '50%-65% of net orderly liquidation value' },
      { label: 'Raw materials', value: '25%-50%, depending on how commoditized and resalable' },
...

  {
    ...
    terms: [
      { label: 'Facility size', value: '$250K - $25MM' },
      { label: 'Advance rate on eligible AR', value: '85%-90%' },
    ...
    versus: {
      ...
      rows: [
        { dimension: 'How much is available', theirs: 'A fixed amount, roughly 10%-15% of annual revenue', ours: '85%-90% of your invoiced receivables, recalculated continuously' },
...

  {
    ...
    howItWorks: [
      ...
      },
      {
        ...
        detail: '65%-75% of expected net collections, not of billed charges. Modeling this first is what keeps the process from ending in disappointment three weeks in.',
      },
      {
    ...
    terms: [
      { label: 'Facility size', value: '$250K - $25MM' },
      { label: 'Advance rate', value: '65%-75% of net collectible value — not of billed charges' },
      ...
      { label: 'Government payor structure', value: 'Two-account lockbox with a deposit account control agreement — direct assignment is barred' },
    ...
    versus: {
      ...
      rows: [
        ...
        { dimension: 'How much is available', theirs: 'Roughly 10%-15% of annual revenue, fixed', ours: '65%-75% of net collectible receivables, recalculated monthly' },
    ...
    faqs: [
      {
        question: 'Why is the advance rate only 65%-75% when commercial lenders advance 85%?',
...

  {
    ...
    howItWorks: [
      ...
      },
      {
        ...
        detail: 'Expect retainage to be excluded or advanced at 0%-25%. Knowing this at the start prevents the common failure, where a contractor counts $900K of retainage toward availability and finds out at closing that it contributed almost nothing.',
      },
      {
    ...
    terms: [
      ...
      { label: 'Retainage', value: 'Excluded, or advanced at 0%-25%' },
    ...
    versus: {
      ...
      rows: [
        { dimension: 'Who will look at it', theirs: 'Few lenders — most decline construction AR outright', ours: 'Many, because machinery collateral is understood everywhere' },
        { dimension: 'What retainage does to it', theirs: 'Excluded or nearly so, which often gutters availability', ours: 'Irrelevant — the collateral is the equipment' },
